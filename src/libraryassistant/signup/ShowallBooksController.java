...
public class ShowallBooksController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        showBook();
        bookInfoTable.setOnMouseClicked(event -> {
            bookInfo book = bookInfoTable.getSelectionModel().getSelectedItem();
            titleEditField.setText(book.getTitle());
            ISBNEditField.setText(book.getIsbn());
            AuthorEditField.setText(book.getAuthor());
            PublisherEditField.setText(book.getPublisher());
            numofCopies.setText(String.valueOf(book.getNumcopies()));
        });
    }

    @FXML
    void updateButtonAction(MouseEvent event) throws SQLException {
