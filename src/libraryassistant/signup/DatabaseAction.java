...
public class DatabaseAction {
    ...
    Connection getConnection() throws SQLException {
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/library_management", "root", "");
        return conn;
    }
    ...
    String updatebookInfo(bookInfo bookinfo) throws SQLException {
        ...
        String query = "UPDATE bookinfo SET bookTitle ='" + bookinfo.getTitle() + "', bookAuthor='" + bookinfo.getAuthor() + "', bookPublisher='" + bookinfo.getPublisher() + "', NumCopies=" + bookinfo.getNumcopies()+ " WHERE bookISBN ='" + bookinfo.getIsbn()+"'";
        if (statement.executeUpdate(query) > 0) {
